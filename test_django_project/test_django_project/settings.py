...
DATABASES = {
    ...
    'postgres': {
	    ...
	    'NAME': 'app_test', # Or path to database file if using sqlite3.
...
MEDIA_ROOT = os.path.join(os.path.split(os.path.dirname(__file__))[0], 'media')
...
SECRET_KEY = '*=l2&amp;n_2=ccm_4ovv3$uhs6(!-mt1%vk!%8)i19j!h7d@pe!i+'
